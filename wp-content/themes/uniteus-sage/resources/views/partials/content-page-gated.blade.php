@php
$acf = $acf['gated_page'];
$style = isset($acf['style']) ? $acf['style'] : '';
@endphp

@if ('oc' == $style)
  <div class="relative">
@endif
<section id="gated-page" class="relative z-10 component-section @if ('oc' != $style) bg-dark-gradient @endif">
  <div class="component-inner-section">
    ...
    <div class="flex flex-col md:relative md:flex-none md:grid md:grid-cols-2 gap-10">
      <div class="text-lg text-white lg:pr-12 xl:pr-20">
        @if ('oc' == $style)
          <img class="mb-10" width="197" height="40" src="@asset('/images/logo-one-continuum.png')" alt="One Continuum logo" />
        @endif

        @if ($acf['featured_image'])
          <div class="featured-image my-6">
            <img @if ('oc' == $style) class="w-full h-auto max-w-sm" @endif src="{{ $acf['featured_image']['sizes']['large'] }}" alt="$acf['featured_image']['alt']" />
          </div>
        @endif
...
@if ($acf['title_2'] OR $acf['description_2'])
  ...
  <section class="relative z-20 component-section gated-section-2">
    <div class="component-inner-section">
  ...
  @if ('oc' == $style)
      <div class="absolute inset-0 z-0">
        <img class="lazy w-full h-full object-cover" data-src="@asset('/images/bg-gated-one-continuum.jpg')" alt="" />
      </div>
    </div>
